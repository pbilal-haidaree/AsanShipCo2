...
function Sidebar({ userRole, activeSection, onSectionChange }) {
  ...
  const adminSections = [
    { id: 'cars', label: 'Manage Cars', icon: (
      <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M7 17m-2 0a2 2 0 1 0 4 0a2 2 0 1 0 -4 0"/><path d="M17 17m-2 0a2 2 0 1 0 4 0a2 2 0 1 0 -4 0"/><path d="M5 17H3v-6l2-5h9l4 5h1a2 2 0 0 1 2 2v4h-2m-4 0H9"/></svg>
    )},
    ...
    { id: 'assign', label: 'Assign Car', icon: (
    ...
    <>
      ...
      <aside className={`sidebar ${mobileOpen ? 'open' : ''}`}>
        ...
        <div className="sidebar-footer">
          <p className="sidebar-text">AsanShipCo &copy; {new Date().getFullYear()}</p>
        </div>
      </aside>
    </>
  );
